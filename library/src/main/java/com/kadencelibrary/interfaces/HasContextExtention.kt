package com.kadencelibrary.interfaces
...
interface HasContextExtensions {
    ...
    fun @receiver:StringRes Int.stringRes(arg: Any? = null, vararg args: Any?): String =
        if (arg == null) getContextForExtensions().getString(this) else getContextForExtensions().getString(
            this,
            arg,
            *args
        )
    ...
    @CheckResult
    @Px
    fun @receiver:DimenRes Int.dimensionPixelSizeRes(): Int =
        getResources().getDimensionPixelSize(this)

    @CheckResult
    @ColorInt
    fun @receiver:ColorRes Int.colorRes(): Int =
        ContextCompat.getColor(getContextForExtensions(), this)

    @CheckResult
    fun @receiver:ColorRes Int.colorStateListRes(): ColorStateList =
        AppCompatResources.getColorStateList(getContextForExtensions(), this)!!

    @CheckResult
    fun @receiver:FontRes Int.fontRes(): Typeface? =
        ResourcesCompat.getFont(getContextForExtensions(), this)
